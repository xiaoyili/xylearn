...
from xylearn.utils.theano_util import toFloatX, toSharedX
from xylearn.utils.helper_util import safe_update
...
class SGDOptimizer(BaseOptimizer):
    ...
    def __init__(self, params, base_lr, anneal_start=None, use_adagrad=False,
        ...
        if anneal_start == None:
            ...
            self.anneal_start = toFloatX(anneal_start)
        ...
        if self.use_adagrad:
            ...
            for param in self.params:
                self.accumulators[param] = theano.shared(value=toFloatX(0.),
                                                         name='acc_%s' % param.name)
                self.e0s[param] = toFloatX(base_lr)
    ...
    def learning_rates_setup(self, base_lr, **kwargs):
        ...
        for parameter in self.params:
            ...
            self.learning_rates[parameter] = toSharedX(thislr, lr_name)
        ...
        self.iteration = toSharedX(theano._asarray(0, dtype='int32'),
                                   name='iter')
        ...
        self.annealed = toSharedX(base_lr, 'annealed')
    ...
    def learning_rate_updates(self, gradients):
        ...
        if self.use_adagrad:
            ...
            if self.anneal_start is None:
                annealed = toSharedX(self.base_lr)
            else:
